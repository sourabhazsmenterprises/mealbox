...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Food Item Create</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Food Item Create</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
<div class="card">
	...
	<div class="card-body">
		<form action="{{ url("admin/food-item/store") }}" method="POST" enctype="multipart/form-data">
			{{csrf_field()}}
<div class="row">
	...
	<div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
						<label> Image</label>
						<input type="file" name="image" value="{{ old('image', isset($fooitem) ? $fooditem->image : '') }}" placehoder="Enter Address" class="form-control" required>      
						@if($errors->has('image'))
                        <p class="help-block">
                        {{ $errors->first('image') }}
						</p>
					  ...
					  <div class="form-group col-md-6">
						...
						<textarea   name="description" value="{{ old('tittle', isset($fooditem) ? $fooditem->description : '') }}" placehoder="Enter Address" class="form-control" required></textarea>   
			...
			<div class="form-group col-md-6">
						<label>Recipe</label>
						<textarea   name="recipe" value="{{ old('tittle', isset($fooditem) ? $fooditem->recipe : '') }}" placehoder="Enter Address" class="form-control" ></textarea>   
	...
	<div class="form-group col-md-6">
						...
						<textarea   name="ingredients" required value="{{ old('tittle', isset($fooditem) ? $fooditem->ingredients : '') }}" placehoder="Enter Address" class="form-control" ></textarea>   
	 ...
	 <div class="form-group col-md-6">
						<label>Price </label>
						<input type="text" name="mainprice" value="{{ old('tittle', isset($fooditem) ? $fooditem->price : '') }}" placehoder="Enter Address" class="form-control" required>      
