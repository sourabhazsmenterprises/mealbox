...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Property Create</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Property Create</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
<div class="card">
	...
	<div class="card-body">
		<form action="{{ url("admin/property/store") }}" method="POST" enctype="multipart/form-data">
			{{csrf_field()}}
					 ...
					 <div class="form-group">
						<label> Tittle *</label>
						<input type="text" name="tittle" value="{{ old('tittle', isset($property) ? $property->tittle : '') }}" placehoder="Enter Address" class="form-control" >      
					 ...
					 <div class="form-group">
						<label> Image *</label>
						<input type="file" name="image" value="{{ old('image', isset($property) ? $property->image : '') }}" placehoder="Enter Address" class="form-control" required>      
						@if($errors->has('image'))
                        <p class="help-block">
                        {{ $errors->first('image') }}
						</p>
